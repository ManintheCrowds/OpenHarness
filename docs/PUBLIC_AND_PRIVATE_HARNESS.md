...
| **Private / experimental** | portfolio-harness, org-internal forks | Real `.cursor/state/`, `handoff_latest.md`, `handoff_archive/`, `daily/`, credentials, experiment code, Med-Vis app data |
...
- portfolio-harness: parser against real `.cursor/state/`, Med-Vis, optional **BrowserStack scan log** rows with real scan IDs (private unless you redact).
