...
| P3 | **Multimodal / UI generation** (§4.4, §9.1) | Relevant to OpenAtlas and frontend work; use **frontend** skills + visual review, not raw prompt-only UX. | `frontend-a2ui`, browser-review-protocol |
